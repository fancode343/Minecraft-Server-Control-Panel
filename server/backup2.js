...
// Paths
const worldFolder = "/home/lmnet/server/server/worlds"; // Change to your world folder
const tempZipPath = `/home/lmnet/server/server/backups/backup-${Date.now()}.zip`;
const folderId = "1mrkAbQR1SoF_dlhPAa0xqQC0Hw3T81Se"; // Replace with your Google Drive folder ID
